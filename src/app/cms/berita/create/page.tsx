  ...
  return (
    <div className="max-w-4xl space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-extrabold text-zinc-900 dark:text-white tracking-tight">Tulis Berita Baru</h1>
          <p className="text-sm text-zinc-500 dark:text-zinc-400">Buat artikel berita atau sosialisasi baru untuk disebarkan.</p>
        </div>
      </div>
