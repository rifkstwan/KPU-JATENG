  ...
  if (fetching) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] gap-3">
        ...
        <span className="font-semibold text-zinc-500 dark:text-zinc-400 text-sm">Memuat detail publikasi...</span>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-3xl space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-extrabold text-zinc-900 dark:text-white tracking-tight">Edit Publikasi</h1>
          <p className="text-sm text-zinc-500 dark:text-zinc-400">Ubah rincian video dokumentasi kegiatan atau sosialisasi KPU Jawa Tengah.</p>
        </div>
      </div>
